...
public class AdapterHienThiBanAn extends BaseAdapter implements View.OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view == null){
            ...
            viewHolderBanAn.imBanAn = (ImageView) view.findViewById(R.id.imgBanAn);
            viewHolderBanAn.imGoiMon = (ImageView) view.findViewById(R.id.imgGoiMon);
            viewHolderBanAn.imThanhToan = (ImageView) view.findViewById(R.id.imgThanhToan);
            viewHolderBanAn.imAnButton = (ImageView) view.findViewById(R.id.imgAnButton);
        ...
        if(kttinhtrang.equals("true")){
            viewHolderBanAn.imBanAn.setImageResource(R.mipmap.banantrue);
        }else{
